...
const Scorecard: React.FC<ScorecardProps> = () => {
	...
	const [playingPartner, setPlayingPartner] = useState<Friend | null>(
		location.state.playingPartner
	);
	const [p2Scorecard, setP2Scorecard] = useState<null | Array<number | null>>(
		null
	);
	...
	const [matchScore, setMatchScore] = useState<Array<number | null>>([
		null,
		null,
		null,
		null,
	...
	const getCourseData = async () => {
		...
		try {
			let data: false | { holes: string } = await apiService(
				`/api/holes/${location.state.selectedCourseId}`
			);
			if (data) {
	...
	const updateP1Scorecard = (
		...
		let newNineTotal = oldScore
			? oldTotal - oldScore + Number(e.target.value)
			: oldTotal + Number(e.target.value);
		if (index < 9) {
		...
		if (!(p1Scorecard.includes(null) || p1Scorecard.includes(0)))
	...
	const updateP2Scorecard = (
		...
		if (Number(e.target.value) > p1Scorecard[p2index]) {
			p2index === 0
				? (matchArray[p2index] = 1)
				: (matchArray[p2index] = matchArray[p2index - 1] + 1);
			...
			p2index === 0
				? (matchArray[p2index] = 0)
				: (matchArray[p2index] = matchArray[p2index - 1]);
		}
		...
		if (!(p2Scorecard.includes(null) || p2Scorecard.includes(0)))
			setScoreComplete(true);
		if (Number(e.target.value) < 1) setScoreComplete(false);
	};
				...
				<div className="container">
					<div className="py-3 d-flex flex-column">
						...
						<div className="text-center">
							Course Rating: {location.state.courseRating} | Slope:{' '}
							{location.state.slope}
						</div>
					</div>
							...
							<table className="table">
								<thead>
									<tr>
										...
										<th
											scope="col"
											className="align-middle text-center extra-width"
										>
											1
										</th>
										<th
									...
									<tr>
										...
										<td className="align-middle text-center">
											<input
												type="number"
												ref={inputRefs[0]}
												onChange={e => updateP1Scorecard(e, 0)}
											/>
										</td>
										<td className="align-middle text-center">
											<input
												type="number"
												ref={inputRefs[1]}
												onChange={e => updateP1Scorecard(e, 1)}
											/>
										</td>
										<td className="align-middle text-center">
											<input
												type="number"
												ref={inputRefs[2]}
												onChange={e => updateP1Scorecard(e, 2)}
											/>
										</td>
										<td className="align-middle text-center">
											<input
												type="number"
												ref={inputRefs[3]}
												onChange={e => updateP1Scorecard(e, 3)}
											/>
										</td>
										<td className="align-middle text-center">
											<input
												type="number"
												ref={inputRefs[4]}
												onChange={e => updateP1Scorecard(e, 4)}
											/>
										</td>
										<td className="align-middle text-center">
											<input
												type="number"
												ref={inputRefs[5]}
												onChange={e => updateP1Scorecard(e, 5)}
											/>
										</td>
										<td className="align-middle text-center">
											<input
												type="number"
												ref={inputRefs[6]}
												onChange={e => updateP1Scorecard(e, 6)}
											/>
										</td>
										<td className="align-middle text-center">
											<input
												type="number"
												ref={inputRefs[7]}
												onChange={e => updateP1Scorecard(e, 7)}
											/>
										</td>
										<td className="align-middle text-center">
											<input
												type="number"
												ref={inputRefs[8]}
												onChange={e => updateP1Scorecard(e, 8)}
											/>
										</td>
										<td className="align-middle text-center">
											{p1FrontNineTotal}
										...
										<td className="align-middle text-center">
											<input
												type="number"
												ref={inputRefs[9]}
												onChange={e => updateP1Scorecard(e, 9)}
											/>
										</td>
										<td className="align-middle text-center">
											<input
												type="number"
												ref={inputRefs[10]}
												onChange={e => updateP1Scorecard(e, 10)}
											/>
										</td>
										<td className="align-middle text-center">
											<input
												type="number"
												ref={inputRefs[11]}
												onChange={e => updateP1Scorecard(e, 11)}
											/>
										</td>
										<td className="align-middle text-center">
											<input
												type="number"
												ref={inputRefs[12]}
												onChange={e => updateP1Scorecard(e, 12)}
											/>
										</td>
										<td className="align-middle text-center">
											<input
												type="number"
												ref={inputRefs[13]}
												onChange={e => updateP1Scorecard(e, 13)}
											/>
										</td>
										<td className="align-middle text-center">
											<input
												type="number"
												ref={inputRefs[14]}
												onChange={e => updateP1Scorecard(e, 14)}
											/>
										</td>
										<td className="align-middle text-center">
											<input
												type="number"
												ref={inputRefs[15]}
												onChange={e => updateP1Scorecard(e, 15)}
											/>
										</td>
										<td className="align-middle text-center">
											<input
												type="number"
												ref={inputRefs[16]}
												onChange={e => updateP1Scorecard(e, 16)}
											/>
										</td>
										<td className="align-middle text-center">
											<input
												type="number"
												ref={inputRefs[17]}
												onChange={e => updateP1Scorecard(e, 17)}
											/>
										</td>
										<td className="align-middle text-center">
											{p1BackNineTotal}
									...
									{playingPartner && (
										<>
											<tr>
												...
												<td className="align-middle text-center">
													<input
														type="number"
														ref={inputRefs[18]}
														onChange={e => updateP2Scorecard(e, 18)}
													/>
												</td>
												<td className="align-middle text-center">
													<input
														type="number"
														ref={inputRefs[19]}
														onChange={e => updateP2Scorecard(e, 19)}
													/>
												</td>
												<td className="align-middle text-center">
													<input
														type="number"
														ref={inputRefs[20]}
														onChange={e => updateP2Scorecard(e, 20)}
													/>
												</td>
												<td className="align-middle text-center">
													<input
														type="number"
														ref={inputRefs[21]}
														onChange={e => updateP2Scorecard(e, 21)}
													/>
												</td>
												<td className="align-middle text-center">
													<input
														type="number"
														ref={inputRefs[22]}
														onChange={e => updateP2Scorecard(e, 22)}
													/>
												</td>
												<td className="align-middle text-center">
													<input
														type="number"
														ref={inputRefs[23]}
														onChange={e => updateP2Scorecard(e, 23)}
													/>
												</td>
												<td className="align-middle text-center">
													<input
														type="number"
														ref={inputRefs[24]}
														onChange={e => updateP2Scorecard(e, 24)}
													/>
												</td>
												<td className="align-middle text-center">
													<input
														type="number"
														ref={inputRefs[25]}
														onChange={e => updateP2Scorecard(e, 25)}
													/>
												</td>
												<td className="align-middle text-center">
													<input
														type="number"
														ref={inputRefs[26]}
														onChange={e => updateP2Scorecard(e, 26)}
													/>
												</td>
												<td className="align-middle text-center">
													{p2FrontNineTotal}
												...
												<td className="align-middle text-center">
													<input
														type="number"
														ref={inputRefs[27]}
														onChange={e => updateP2Scorecard(e, 27)}
													/>
												</td>
												<td className="align-middle text-center">
													<input
														type="number"
														ref={inputRefs[28]}
														onChange={e => updateP2Scorecard(e, 28)}
													/>
												</td>
												<td className="align-middle text-center">
													<input
														type="number"
														ref={inputRefs[29]}
														onChange={e => updateP2Scorecard(e, 29)}
													/>
												</td>
												<td className="align-middle text-center">
													<input
														type="number"
														ref={inputRefs[30]}
														onChange={e => updateP2Scorecard(e, 30)}
													/>
												</td>
												<td className="align-middle text-center">
													<input
														type="number"
														ref={inputRefs[31]}
														onChange={e => updateP2Scorecard(e, 31)}
													/>
												</td>
												<td className="align-middle text-center">
													<input
														type="number"
														ref={inputRefs[32]}
														onChange={e => updateP2Scorecard(e, 32)}
													/>
												</td>
												<td className="align-middle text-center">
													<input
														type="number"
														ref={inputRefs[33]}
														onChange={e => updateP2Scorecard(e, 33)}
													/>
												</td>
												<td className="align-middle text-center">
													<input
														type="number"
														ref={inputRefs[34]}
														onChange={e => updateP2Scorecard(e, 34)}
													/>
												</td>
												<td className="align-middle text-center">
													<input
														type="number"
														ref={inputRefs[35]}
														onChange={e => updateP2Scorecard(e, 35)}
													/>
												</td>
												<td className="align-middle text-center">
													{p2BackNineTotal}
											...
											<tr>
												<td
													style={{ left: '0' }}
													className="position-absolute bg-dark w-100 text-center font-weight-bold text-white"
												>
													Match Play
												</td>
											...
											<tr>
												...
												<td className="position-relative">
													{matchScore[0] > 0 && (
														<div className="position-absolute h-100 w-100 bg-info text-white border d-flex align-items-center justify-content-center">
															{matchScore[0] + 'UP'}
														</div>
													)}
												</td>
											...
											<tr>
												...
												<td className="position-relative">
													{matchScore[0] === 0 && (
														<div className="position-absolute h-100 w-100 bg-dark text-white border d-flex align-items-center justify-content-center">
															TIED
														</div>
													)}
												</td>
