...
const Header: React.FC<NavbarProps> = ({ color, loggedIn, logOut }) => {
				...
				<Navbar expand="lg" className="pr-1">
					...
					<Navbar.Collapse id="basic-navbar-nav">
						<Nav className="ml-auto">
							...
							{loggedIn ? (
								<button
									className="btn btn-danger rounded-0 h-25 text-white"
								...
								<>
									...
									<Link
										to="/register"
										className="btn btn-primary rounded-0 h-25 text-white"
									>
										Sign Up
									</Link>
								</>
